...
public class FXMLCadastrarClientesController implements Initializable {
    ...
    @FXML
    private DatePicker datePickerClienteDataDeNascimento;
    @FXML
    private CheckBox checkBoxClienteDividas;
